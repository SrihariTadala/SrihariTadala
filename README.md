...
##   Projects
- **ElderConnect** – LLM-powered portal for caregivers with multimodal input and AI-assisted activity planning  
- **EasySplit** – AI receipt scanner for OCR-based item detection and smart bill splitting with summaries  
- **Freight Quote Agent** – Email → route → PDF freight quotes using LLM extraction and Mapbox
- **LearnLab** – PDF → quizzes, flashcards, podcasts using RAG, LangGraph, and semantic caching  


## Contact
- LinkedIn: https://www.linkedin.com/in/sriharitadala/
- Email: sriharitadala@gmail.com
